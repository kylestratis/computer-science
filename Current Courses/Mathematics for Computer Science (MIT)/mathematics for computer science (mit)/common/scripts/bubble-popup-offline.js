...
'icon-question-cl.png':'Crosslinks shows how STEM topics are introduced, developed and applied across select MIT undergraduate subjects. For each topic, a page lists OCW and other online resources that MIT students have found helpful. <a href="http://ocw.mit.edu/courses/crosslinks/">Learn more</a>.',
};
